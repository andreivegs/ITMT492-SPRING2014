...
String indentifySensor(int a1, int a2, int a3, int a4) {
  ...
  return "Temperature from router - sensor 1"; } //temp data is from XBee one
  else if(a1==end1[0] && a2==end1[1] && a3==end1[2] && a4==end1[3]) {//Check if Sensor 2
  return "Temperature from end - sensor 2"; } //temp data is from XBee two
  else if(a1==end2[0] && a2==end2[1] && a3==end2[2] && a4==end2[3]) {//Check if Sensor 2
  return "Temperature from end - sensor 3"; } //temp data is from XBee two
